...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputGetLogs();
  });
  ...
  describe('OutputGetLogs', function() {
    it('should create an instance of OutputGetLogs', function() {
      // uncomment below and update the code to test OutputGetLogs
      //var instance = new QanAutoApi.OutputGetLogs();
      //expect(instance).to.be.a(QanAutoApi.OutputGetLogs);
    });
