...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputGetTransactionCount();
  });
  ...
  describe('OutputGetTransactionCount', function() {
    it('should create an instance of OutputGetTransactionCount', function() {
      // uncomment below and update the code to test OutputGetTransactionCount
      //var instance = new QanAutoApi.OutputGetTransactionCount();
      //expect(instance).to.be.a(QanAutoApi.OutputGetTransactionCount);
    });
