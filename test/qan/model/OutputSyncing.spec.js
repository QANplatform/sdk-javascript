...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputSyncing();
  });
  ...
  describe('OutputSyncing', function() {
    it('should create an instance of OutputSyncing', function() {
      // uncomment below and update the code to test OutputSyncing
      //var instance = new QanAutoApi.OutputSyncing();
      //expect(instance).to.be.a(QanAutoApi.OutputSyncing);
    });
