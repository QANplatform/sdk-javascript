...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputGetTransactionByHash();
  });
  ...
  describe('OutputGetTransactionByHash', function() {
    it('should create an instance of OutputGetTransactionByHash', function() {
      // uncomment below and update the code to test OutputGetTransactionByHash
      //var instance = new QanAutoApi.OutputGetTransactionByHash();
      //expect(instance).to.be.a(QanAutoApi.OutputGetTransactionByHash);
    });
