...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputSendRawTransaction();
  });
  ...
  describe('OutputSendRawTransaction', function() {
    it('should create an instance of OutputSendRawTransaction', function() {
      // uncomment below and update the code to test OutputSendRawTransaction
      //var instance = new QanAutoApi.OutputSendRawTransaction();
      //expect(instance).to.be.a(QanAutoApi.OutputSendRawTransaction);
    });
