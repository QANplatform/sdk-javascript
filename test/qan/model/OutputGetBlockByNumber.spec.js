...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputGetBlockByNumber();
  });
  ...
  describe('OutputGetBlockByNumber', function() {
    it('should create an instance of OutputGetBlockByNumber', function() {
      // uncomment below and update the code to test OutputGetBlockByNumber
      //var instance = new QanAutoApi.OutputGetBlockByNumber();
      //expect(instance).to.be.a(QanAutoApi.OutputGetBlockByNumber);
    });
