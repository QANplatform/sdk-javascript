...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.InputCall();
  });
  ...
  describe('InputCall', function() {
    it('should create an instance of InputCall', function() {
      // uncomment below and update the code to test InputCall
      //var instance = new QanAutoApi.InputCall();
      //expect(instance).to.be.a(QanAutoApi.InputCall);
    });
