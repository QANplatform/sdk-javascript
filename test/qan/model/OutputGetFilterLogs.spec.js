...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputGetFilterLogs();
  });
  ...
  describe('OutputGetFilterLogs', function() {
    it('should create an instance of OutputGetFilterLogs', function() {
      // uncomment below and update the code to test OutputGetFilterLogs
      //var instance = new QanAutoApi.OutputGetFilterLogs();
      //expect(instance).to.be.a(QanAutoApi.OutputGetFilterLogs);
    });
