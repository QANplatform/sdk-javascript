...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputXlinkValid();
  });
  ...
  describe('OutputXlinkValid', function() {
    it('should create an instance of OutputXlinkValid', function() {
      // uncomment below and update the code to test OutputXlinkValid
      //var instance = new QanAutoApi.OutputXlinkValid();
      //expect(instance).to.be.a(QanAutoApi.OutputXlinkValid);
    });
