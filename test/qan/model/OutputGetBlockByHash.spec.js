...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputGetBlockByHash();
  });
  ...
  describe('OutputGetBlockByHash', function() {
    it('should create an instance of OutputGetBlockByHash', function() {
      // uncomment below and update the code to test OutputGetBlockByHash
      //var instance = new QanAutoApi.OutputGetBlockByHash();
      //expect(instance).to.be.a(QanAutoApi.OutputGetBlockByHash);
    });
