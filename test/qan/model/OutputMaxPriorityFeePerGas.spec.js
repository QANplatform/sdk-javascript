...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputMaxPriorityFeePerGas();
  });
  ...
  describe('OutputMaxPriorityFeePerGas', function() {
    it('should create an instance of OutputMaxPriorityFeePerGas', function() {
      // uncomment below and update the code to test OutputMaxPriorityFeePerGas
      //var instance = new QanAutoApi.OutputMaxPriorityFeePerGas();
      //expect(instance).to.be.a(QanAutoApi.OutputMaxPriorityFeePerGas);
    });
