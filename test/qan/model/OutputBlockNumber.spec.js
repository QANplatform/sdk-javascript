...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.OutputBlockNumber();
  });
  ...
  describe('OutputBlockNumber', function() {
    it('should create an instance of OutputBlockNumber', function() {
      // uncomment below and update the code to test OutputBlockNumber
      //var instance = new QanAutoApi.OutputBlockNumber();
      //expect(instance).to.be.a(QanAutoApi.OutputBlockNumber);
    });
