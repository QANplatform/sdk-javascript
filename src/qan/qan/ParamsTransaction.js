 ...
 * @module qan/qan/ParamsTransaction
 * @version 0.0.2
 */
class ParamsTransaction {
    /**
     * Constructs a new <code>ParamsTransaction</code>.
     * @alias module:qan/qan/ParamsTransaction
     ...
     * @param {module:qan/qan/ParamsTransaction} obj Optional instance to populate.
     * @return {module:qan/qan/ParamsTransaction} The populated <code>ParamsTransaction</code> instance.
     */
