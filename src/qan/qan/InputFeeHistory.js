 ...
 * @module qan/qan/InputFeeHistory
 * @version 0.0.2
 */
class InputFeeHistory {
    /**
     * Constructs a new <code>InputFeeHistory</code>.
     * @alias module:qan/qan/InputFeeHistory
     ...
     * @param {module:qan/qan/InputFeeHistory} obj Optional instance to populate.
     * @return {module:qan/qan/InputFeeHistory} The populated <code>InputFeeHistory</code> instance.
     */
