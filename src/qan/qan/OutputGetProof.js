 ...
 * @module qan/qan/OutputGetProof
 * @version 0.0.2
 */
class OutputGetProof {
    /**
     * Constructs a new <code>OutputGetProof</code>.
     * @alias module:qan/qan/OutputGetProof
     ...
     * @param storageProof {Array.<module:qan/qan/ResponseStorageEntry>} An array of storage-entries as requested. Each entry is an object with the following fields:
     */
     ...
     * @param {module:qan/qan/OutputGetProof} obj Optional instance to populate.
     * @return {module:qan/qan/OutputGetProof} The populated <code>OutputGetProof</code> instance.
     */
 ...
 * @member {Array.<module:qan/qan/ResponseStorageEntry>} StorageProof
 */
