 ...
 * @module qan/qan/EstimateGasObject
 * @version 0.0.2
 */
class EstimateGasObject {
    /**
     * Constructs a new <code>EstimateGasObject</code>.
     * @alias module:qan/qan/EstimateGasObject
     */
    constructor() { 
     ...
     * @param {module:qan/qan/EstimateGasObject} obj Optional instance to populate.
     * @return {module:qan/qan/EstimateGasObject} The populated <code>EstimateGasObject</code> instance.
     */
