 ...
 * @module qan/qan/ResponseWithdrawals
 * @version 0.0.2
 */
class ResponseWithdrawals {
    /**
     * Constructs a new <code>ResponseWithdrawals</code>.
     * @alias module:qan/qan/ResponseWithdrawals
     * @param address {String} The address to which the withdrawn amount is sent
     * @param amount {String} The amount of value, provided in decimal format, corresponding to a certain value in gwei
     ...
     * @param {module:qan/qan/ResponseWithdrawals} obj Optional instance to populate.
     * @return {module:qan/qan/ResponseWithdrawals} The populated <code>ResponseWithdrawals</code> instance.
     */
