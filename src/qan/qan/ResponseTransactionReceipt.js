 ...
 * @module qan/qan/ResponseTransactionReceipt
 * @version 0.0.2
 */
class ResponseTransactionReceipt {
    /**
     * Constructs a new <code>ResponseTransactionReceipt</code>.
     * @alias module:qan/qan/ResponseTransactionReceipt
     */
    constructor() { 
     ...
     * @param {module:qan/qan/ResponseTransactionReceipt} obj Optional instance to populate.
     * @return {module:qan/qan/ResponseTransactionReceipt} The populated <code>ResponseTransactionReceipt</code> instance.
     */
