 ...
 * @module qan/qan/ResponseTransaction
 * @version 0.0.2
 */
class ResponseTransaction {
    /**
     * Constructs a new <code>ResponseTransaction</code>.
     * @alias module:qan/qan/ResponseTransaction
     */
    constructor() { 
     ...
     * @param {module:qan/qan/ResponseTransaction} obj Optional instance to populate.
     * @return {module:qan/qan/ResponseTransaction} The populated <code>ResponseTransaction</code> instance.
     */
