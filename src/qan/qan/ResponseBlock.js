 ...
 * @module qan/qan/ResponseBlock
 * @version 0.0.2
 */
class ResponseBlock {
    /**
     * Constructs a new <code>ResponseBlock</code>.
     * @alias module:qan/qan/ResponseBlock
     ...
     * @param transactions {Array.<module:qan/qan/ResponseTransaction>} An array of transaction objects - please see getTransactionByHash for exact shape
     ...
     * @param withdrawals {module:qan/qan/ResponseWithdrawals} A withdrawals object contains information about withdrawals made by validators. Please note that this field will not be included in a block requested before the EIP-4895 upgrade
     ...
     * @param {module:qan/qan/ResponseBlock} obj Optional instance to populate.
     * @return {module:qan/qan/ResponseBlock} The populated <code>ResponseBlock</code> instance.
     */
 ...
 * @member {Array.<module:qan/qan/ResponseTransaction>} Transactions
 */
 ...
 * @member {module:qan/qan/ResponseWithdrawals} Withdrawals
 */
